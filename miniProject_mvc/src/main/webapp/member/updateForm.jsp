		...
		<table border ="1" width="500" cellpadding="10">
			...
			<tr>
				...
				<td>
					...
					-
					<input type="tel" name="tel2" maxlength="4" value="${memberDTO.tel2 }" style="width:50px;"/>
					-
					<input type="tel" name="tel3" maxlength="4"value="${memberDTO.tel3 }" style="width:50px;"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input type="text" name="email2" list="email2" value="${memberDTO.email2 }"/>
					<datalist id=email2>
...
<!-- 					<select id="email3" name="email3" onchange="change()">
			...
			<tr>
				...
				<td>
					<input type="text" name="zipcode" id="zipcode" value="${memberDTO.zipcode }" readonly  style="margin-bottom:5px;"/>
					<input type="button" value="우편번호검색" onclick="checkPost()"/><br>
					<input type="text" id="addr1" name="addr1" value="${memberDTO.addr1 }" readonly placeholder="주소" style="width:330px; margin-bottom:5px;"/><br>
					<input type="text" id="addr2" name="addr2" value="${memberDTO.addr2 }" placeholder="상세주소" style="width:330px;"/>
